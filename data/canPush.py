...
explanation_force = [
                    ...
                    "equal(integer#40,integer#40)"
                    ]

# =============== Explanations why the class PushableDisposition is inferred =============
pushable_easy = "PushableDisposition|EquivalentTo|"
pushable_medium= "PushableDisposition|EquivalentTo|(isDispositionOf some (hasPart some Wheel))"
pushable_hard = "PushableDisposition|EquivalentTo|(isDispositionOf some (hasPart some (Wheel and (isBlocked value boolean#false)))"
...
pushing_easy = "PushingCapability|EquivalentTo|"
pushing_medium= "PushingCapability|EquivalentTo|(isCapabilityOf some (hasGripper min 1 Gripper)"
pushing_hard = "PushingCapability|EquivalentTo|(isCapabilityOf some (hasGripper min 1 (Gripper and RigidEndEffector))"
...
question_push_easy = QuestionInstance(name="q_push_easy", fact=fact_push, explanations=explanations_push_easy,
                                       rule=push_rule, classes_var=class_variables_final_push, template_dict=template_dict_push)

question_push_medium= QuestionInstance(name="q_push_medium", fact=fact_push, explanations=explanations_push_medium,
                                       rule=push_rule, classes_var=class_variables_final_push, template_dict=template_dict_push)

question_push_hard = QuestionInstance(name="q_push_hard", fact=fact_push, explanations=explanations_push_hard,
                                       rule=push_rule, classes_var=class_variables_final_push, template_dict=template_dict_push)