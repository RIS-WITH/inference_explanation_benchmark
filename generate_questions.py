...
from data.examples import example_0, example_1, example_2
from data.prompts import prompt_test, prompt_rdf
...
if __name__ == '__main__':
    ...
    examples_list = [example_1, example_2]
    ...
    prompt_generator = PromptGenerator(prompt_rdf)

    generator = QuestionGenerator(prompt_generator)
    
    saving_path = "/home/bdussard/"
    directory_name = "dataset_questions_glpp"
