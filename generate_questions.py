...
from data.examples import example_0, example_1, example_2, example_3
...
if __name__ == '__main__':
    ...
    examples_list = [example_1, example_2, example_3]
    ...
    directory_name = "dataset_questions_wihtout_explanations"
